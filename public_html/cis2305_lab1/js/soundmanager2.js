...
(function(window, _undefined) {
  ...
  function SoundManager(smURL, smID) {
    ...
    this.setupOptions = {
      ...
      'waitForWindowLoad': true,         // JYS force SM2 to wait for window.onload() before trying to call soundManager.onload()
      'bgColor': '#ffffff',               // SWF background color. N/A when wmode = 'transparent'
      'useHighPerformance': true,        // JYS position:fixed flash movie can help increase js/flash speed, minimize lag
    ...
    this.defaultOptions = {
      ...
      'autoLoad': true,        // JYS enable automatic loading (otherwise .load() will be called on demand with .play(), the latter being nicer on bandwidth - if you want to .load yourself, you also can)
      'autoPlay': true,        // JYS enable playing of file as soon as possible (much faster if "stream" is true)
